  ...
  return (
   <div className="h-full w-full flex flex-wrap overflow-auto items-center gap-x-8 justify-center">
    ...
    <div className=" hidden md:block w-[380px] h-[581px] bg-logo-pattern relative bg-[length:468.32px_634.15px] bg-[top_left_-46px]">
      ...
      <img className="w-full h-full absolute top-0 left-0 opacity-0 duration-1000 ease-linear transition-opacity"src="https://www.instagram.com/static/images/homepage/screenshots/screenshot1-2x.png/cfd999368de3.png" alt="" />
      <img className="w-full h-full absolute top-0 left-0 opacity-0 duration-1000 ease-linear transition-opacity"src="https://www.instagram.com/static/images/homepage/screenshots/screenshot2-2x.png/80b8aebdea57.png" alt="" />
      <img className="w-full h-full absolute top-0 left-0 opacity-0 duration-1000 ease-linear transition-opacity"src="https://www.instagram.com/static/images/homepage/screenshots/screenshot3-2x.png/fe2540684ab2.png" alt="" />
      <img className="w-full h-full absolute top-0 left-0 opacity-0 duration-1000 ease-linear transition-opacity"src="https://www.instagram.com/static/images/homepage/screenshots/screenshot4-2x.png/8e9224a71939.png" alt="" />
      </div>
    </div>
    ...
    <div className="bg-white border p-[40px] pt-10 pb-2 ">
      ...
      <form className="grid gap-y-1.5">
        ...
        <button disabled={!enable} type="submit" className="h-[30px] mt-1 rounded bg-brand text-white disabled:opacity-50">Log In</button>
